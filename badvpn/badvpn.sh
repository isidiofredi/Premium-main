...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/isidiofredi/Premium-main/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/isidiofredi/Premium-main/main/badvpn/antcrashvpn.sh -o /dev/null
